        ...
        <>
            <div className="project7--container">
                <div className="project7--banner-container">
                    <img src="../img/case_studies/project7/p7_banner.png" className="project7--banner-img"/>
                    <h1 className="project7--banner-title">In Search of Value - AirBnB Price Prediction Model</h1>
                </div>

                <div className="project7--intro-container">
                    <h2 className="project7--title">Honeymoon in Dublin</h2>
                    ...
                    <h2 className="project7--title">Project Goal</h2>
                    <p className="project7--body">
                ...
                <div className="project7--data-container">
                    <div>
                        <h2 className="project7--title">About the Data</h2>
                        <p className="project7--body">
                ...
                <div className="project7--data-exploration">
                    <h2 className="project7--title">Data Exploration</h2>
                    <p className="project7--body">
                    ...
                    <ol className="project7--list">
                        <li className="project7--list-item">
                ...
                <div className="project7--baseline-container">
                    <h2 className="project7--title">Building a Baseline Model</h2>
                    <div className="project7--img-container">
                ...
                <div className="project7--feature-container">
                    <h2 className="project7--title">Multiple Regression and Feature Selection</h2>
                    <p className="project7--body">
                    ...
                    <h2 className="project7--title">Random Forest and Hyper Parameter Tuning</h2>
                    <p className="project7--body">
                    ...
                    <div>
                        <div>
                            ...
                            <ul className="project7--list">
                                <li className="project7--list-item">The MAE is now down to about $19</li>
                                <li className="project7--list-item">The RMSE is about $26.47</li>
                                <li className="project7--list-item">And R^2 is about 0.6 </li>
                            </ul>
                            <p className="project7--body">
                ...
                <div className="project7--maps-container">
                    <h2 className="project7--title">Map Visualization</h2>
                    <p className="project7--body">
                    ...
                    <h2 className="project7--title">Moving Forward</h2>
                    <p className="project7--body">Moving forward there are two major areas I would like to expand on.</p>
                    <ul className="project7--list">
                        <li className="project7--list-item">
