        ...
        <>
            <div className="project8--container">
                ...
                <div className="project8--intro-container">
                    ...
                    <ul className="project8--list">
                        <li className="project8--list-item">
                            Predict whether a review is ‘positive’ or ‘negative’ based on the words used in the review (positive is any review with 
                            4 or 5 stars, and negative reviews are those with 3 stars or less).
                        </li>
                        <li className="project8--list-item">
                ...
                <div className="project8--getting-started-container">
                    <h2 className="project8--started-title">
                    ...
                    <p className="project8--quote">
                        Sentiment analysis uses data mining processes and techniques to extract and capture data for analysis in order to discern the 
                    ...
                    <ul className="project8--list">
                        ...
                        <li className="project8--list-item">
                            Of the almost 6,700,000 reviews about 64% are positive and 36% are negative.
                        </li>
                    </ul>
                ...
                <div className="project8--preparing-container">
                    ...
                    <h2 className="project8--preparing-title">
                        Preparing the Data
                    </h2>

                    <p className="project8--preparing-text">
                    ...
                    <p className="project8--preparing-text">
                        Filtering steps for each review:  
                    </p>
                ...
                <div className="project8--results-container">
                    <h2 className="project8--results-title">
                        Create Features
                    </h2>
                    <p className="project8--results-text">
                ...
                <div className="project8--final-container">
                    <h2 className="project8--final-title">
                        Final Thoughts
                    </h2>
                    <p className="project8--final-text">
